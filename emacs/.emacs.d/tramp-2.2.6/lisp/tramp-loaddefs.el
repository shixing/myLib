...
;;;;;;  "tramp-cache" "tramp-cache.el" (20838 10484))
...
;;;;;;  tramp-cleanup-connection) "tramp-cmds" "tramp-cmds.el" (20838
;;;;;;  10484))
...
;;;;;;  "tramp-gvfs" "tramp-gvfs.el" (20838 10484))
...
;;;;;;  "tramp-sh" "tramp-sh.el" (20838 10484))
...
(add-to-list (quote tramp-methods) (quote ("plink1" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-1" "-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-default-port 22))))
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (20838 10504))
...
;;;;;;  "tramp-util.el" "tramp-vc.el") (20838 10504 725107))
